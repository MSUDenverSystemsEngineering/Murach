...
Try {
	...
	[string]$appVendor = 'Joel Murach'
	[string]$appName = 'Beginning Java with NetBeans'
	[string]$appVersion = ''
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '01/15/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		If (Test-Path -Path "${envSystemDrive}\Murach" -PathType "Container") {
			Remove-File -Path "${envSystemDrive}\Murach\*" -Recurse
		} Else {
			New-Folder -Path "${envSystemDrive}\Murach"
		}
		...
		Copy-File -Path "$dirFiles\*" -Destination "${envSystemDrive}\Murach" -Recurse
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBj9a2v5AcaMCpm
# cQC0XXMDPsBzYRfpGT7f+FbdJCpDO6CCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIANV
# lYW/YLUIyMcLKpFpilefBY84O2xEZ5awQi/OW/Z4MA0GCSqGSIb3DQEBAQUABIIB
# AGoIJFabq+pMv8sBZ5EVpSwVA85GldJI6DzZ0I33c0+mQA7AyiLNE+3rpFaN9fOF
# zFUY3Pv4UKyF+ASErs8Bzi9sDyXesSjDWIlbNLGvxeS8nrU+9tLGh1z+y29PIFif
# 7qHiXYG829er/xcVy2KG1z2v/qZr8J1ZJTxxo1kLJJPKWBxP/QBaUkcO5FnKmX8W
# i+3rm7dI/gMLVNEib/iIO5eR5e/o4SOX3wsimNUdYeykyWDjl/zRtdca9tXy7fpn
# eVJxD1oC7FQceGo2vcbQs7tSVqWbtYhqaXoJadpd8Zp+H1vnNbglt2HSHzJUoLSE
# VcidX4ZX11KACjqKmkEhkBahggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTgwMTE2MDEwMTI1WjAjBgkqhkiG9w0BCQQxFgQU
# ih63jtMirRtmzP3bTVcxOlnw+iwwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBABxZepjDRRW6MB8ngsEmCQFcS+NRdM5oGaqPnyQEbjo1x3wsONHjRzoc
# Gu0PK2jfnfJz58SSjU8TP/o9aCw/A8HHlLtjN+VhHqOGgyz6I7uFz6qhqOtShARJ
# ZM3fZWhW0+mlcohC5fVvz/nKzW9gSiasHaChP8JtCz5VR9YKklrkrLEixFjcYU/n
# TBjCgdsxe5jXFRviwpuKZcGoMm7SJJVrJOQQHJ2yp7XMkwnBOUZVq7sUhputRu78
# 5h4vwuFObiIaRgsaZ/jrneD+s0nxRf5Uvm/zcAsEthd1rrh0EBKQOnPvY6sTPdm6
# fRpIxjLspCWOTDFzJ2lwJ14DV4689j8=
